...
In Lecture 1, we introduced the hospital readmissions dataset and its consequential decisions. In Lecture 2, we explored the data and found the mess. Now we roll up our sleeves.
...
The leakage is visible directly in the correlations. Recall that **correlation** measures the strength of the linear relationship between two variables, ranging from -1 (perfect negative) to +1 (perfect positive), with 0 indicating no linear relationship. We will formalize correlation in Lecture 4.
