...
Chapter 17 returns to feature choice from the AI angle: what happens when a language model picks features for you? Chapters 18-19 ask a different question: when can we move from "are these features associated with the outcome?" to "do these features *cause* the outcome?" Clustering revealed structure; causal inference asks whether the structure is the kind we can intervene on.
