...
## The clustering gotcha

A quick, uncritical analysis — asked to "cluster these Airbnb listings" — typically:

1. Runs k-means with default settings
2. Reports 3 or 5 "beautiful" clusters
3. Maybe makes a scatter plot
4. Moves on

And skips:

- Checking whether the clusters are dominated by geography
- Trying different feature sets to see how clusters change
- Running with multiple random seeds to check stability
- Questioning whether $k=3$ is the right choice or just an arbitrary default
- Interpreting what each cluster actually represents
