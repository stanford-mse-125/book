...
The tree's test performance is comparable to (or slightly worse than) the linear model with hand-engineered interactions. Let's visualize what the tree learned using `plot_tree`.
