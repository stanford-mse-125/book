...
You may have heard "regression minimizes the sum of squared errors." Now you can see *why*: the prediction that minimizes $\|y - \hat{y}\|^2$ is exactly the orthogonal projection of $y$ onto $\text{col}(X)$. Least squares turns out to be equivalent to maximum likelihood estimation when the errors are normally distributed — a connection you may see in a later course.
