...
<!-- FLAG: Data 8 Ch 15 emphasizes the correlation coefficient r and the regression line formula ŷ = r*(SD_y/SD_x)*(x - mean_x) + mean_y for simple regression. Also discusses "regression to the mean" as a general phenomenon. Consider whether to add a section or example connecting r to R^2 in the simple case (R^2 = r^2). -->
