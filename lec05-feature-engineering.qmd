...
The multiplicative structure explains why the semilog scatter plot in [Chapter 2](lec02-eda.qmd) showed a roughly straight line: the relationship between accommodates and price is approximately multiplicative, which is exactly what a $\log(y) \sim x$ model captures.
