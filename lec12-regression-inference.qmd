...
# Annotations to overlay on each panel — help students connect Q-Q shape to distribution shape
annotations = {
...
for ax, (label, data) in zip(axes.flat, sim_data.items()):
    ...
    # Add annotation arrow if defined for this panel
    ...
    if ann is not None:
        ...
        ax.annotate(ann['text'], xy=xy, xytext=xytext, fontsize=8,
