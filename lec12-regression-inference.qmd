...
<!-- FLAG: IMS Ch 24 mentions prediction intervals vs confidence intervals for the mean response as a topic (though marks it out of scope). Consider adding a brief note distinguishing "CI for the mean response at x" from "prediction interval for a new observation at x" in a future revision. -->
