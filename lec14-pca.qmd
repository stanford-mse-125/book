...
If your data is *not* approximately low-rank — every feature is independent and identically distributed noise, say — then no rank-$k$ approximation will help. PCA still runs; it just has nothing to find. The scree plot tells you which regime you are in: a sharp drop after a few PCs means PCA will help, a flat scree means it will not.
