...
This is a critical lesson: without standardization, PCA is dominated by whichever feature has the largest scale.
:::
...
<!-- FLAG: Reading assignment VMLS Ch 16 may not align with PCA content — consider reassigning -->
...
Among all rank-$k$ approximations to $X$, the truncated SVD has the smallest total squared error. No other $k$-dimensional summary can do better.
:::
...
This is one of the most common PCA mistakes in practice. Always check whether your data has been standardized. Standardize before PCA unless you have a specific reason not to (e.g., all features are already on the same scale).
:::
