...
Jung et al. (2020) studied roughly 150,000 pretrial cases in a large US jurisdiction. The naive numbers told a surprising story: defendants released on bail had a 9% FTA rate, while defendants released without bail had a 15% FTA rate. Bail appeared to *reduce* flight risk. But is that causal, or are judges assigning bail to defendants who would have shown up anyway?
...
The naive comparison underestimates the benefit of bail (or may even reverse the sign) because it compares fundamentally different populations.
...
In the actual study by Jung et al. (2020), propensity score matching revealed that the counterfactual FTA rate for bailed defendants --- their predicted FTA rate *without* bail --- would have been 18%, not the 15% observed in the no-bail group. Bail reduced FTA from 18% to 9%, a substantial effect. At the same time, the analysis showed that 35% of detained defendants could have been released without increasing flight risk, informing pretrial reform debates about who really needs to be held.
