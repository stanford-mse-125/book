...
The bootstrap distribution tells us how much the treatment effect estimate would vary across different samples. We can summarize this with a **confidence interval**.
...
You may have heard of the **Law of Large Numbers** (LLN) from MS&E 120 as well. The LLN says the sample mean *converges* to the population mean. The CLT tells you **how fast** (at rate $1/\sqrt{n}$) and **in what shape** (normal).
:::
