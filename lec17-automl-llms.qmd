...
13. **Check for Goodhart's Law.** Could optimizing this metric cause people to game it? (Ch 10)
14. **Check for feedback loops.** Could the model's predictions change the outcome it measures? (Ch 18)
