...
Training $R^2$ increases monotonically, as guaranteed. The test $R^2$ tells a different story.
...
By degree 7, the model has over 3,000 features for only 300 training observations. The result is catastrophic overfitting.
