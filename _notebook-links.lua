...
function Pandoc(doc)
  ...
  local link_html = '<div class="notebook-links" style="margin-bottom: 1em; padding: 0.5em 1em; background: #f8f9fa; border-radius: 6px; font-size: 0.9em;">'
    .. '<a href="' .. colab_url .. '" target="_blank" aria-label="Open in Colab">'
    .. colab_badge_svg
    .. '</a>'
    .. '&nbsp;&nbsp;'
