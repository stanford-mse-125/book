...
<!-- FLAG: IMS Ch 2 covers contingency tables, row/column proportions, mosaic plots, and log transformations of skewed data in detail. This lecture mentions contingency tables and proportions only in the study guide. Consider adding a worked example with pd.crosstab() in a future revision, and/or a log-transform example for the Airbnb price data. -->
