...
Motivation is a **confounder**: it affects both the treatment (attending OH) and the outcome (grades), creating an association between them that overstates the causal effect of OH attendance alone.
