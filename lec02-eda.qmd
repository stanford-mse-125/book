...
Now the pattern pops out: about half of CABG records are suppressed, compared to only ~8% of heart failure records. This is the same finding we saw in the bar chart above, but a contingency table makes it precise and easy to compare across all conditions at once.
