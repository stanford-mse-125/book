...
# Raw distribution
airbnb['price'].hist(bins=100, ax=axes[0], edgecolor='white')
axes[0].set_xlabel('Price ($)')
axes[0].set_ylabel('Count')
axes[0].set_title('All prices')

# Zoomed in
airbnb[airbnb['price'].between(1, 500)]['price'].hist(bins=50, ax=axes[1], edgecolor='white')
...
On the raw scale, expensive listings in the $500–$999 range make it hard to see any pattern among the majority. On the log scale, a clear upward trend emerges: each additional guest corresponds to roughly a multiplicative increase in price. We'll use this idea extensively when we build regression models in Chapter 5.
