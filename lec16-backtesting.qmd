...
The problem isn't your model — it's how you evaluated it. When data has a **temporal structure**, the standard random train/test split silently lies to you. This chapter shows exactly how, quantifies the damage, and demonstrates the right way to validate time series models.
