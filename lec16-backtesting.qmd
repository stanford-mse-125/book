...
Even a model with decent R-squared doesn't necessarily translate to profit in a betting market — the market already incorporates the information your model uses. This gap between statistical performance and economic value is a recurring theme in applied statistics.
