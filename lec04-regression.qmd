...
For a linear model, this set is the set of all possible predictions. It tells you what your model **can** and **cannot** predict, before you fit anything. Let's visualize it in 3D, where the geometry is easier to see.
